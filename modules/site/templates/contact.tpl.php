        ...
        <div class="dm3-two-third">
          ...
          <div role="form" lang="en-US" dir="ltr">
            ...
            <form id="contact" action="<?php echo uri('contact') ?>" method="post" class="wpcf7-form" novalidate="novalidate">
              ...
              <p class="field-one-half" style="margin-left: 0px">
                <label>Phone <span class="required">*</span></label><span class="wpcf7-form-control-wrap your-phone"><input type="text" required="required" name="contact[phone]" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-phone wpcf7-validates-as-required wpcf7-validates-as-phone" aria-required="true" aria-invalid="false" /></span>
              </p>
              <p class="field-one-half">
                <label>Country <span class="required">*</span></label><span class="wpcf7-form-control-wrap your-country">
                  <select required="required" name="contact[country]" class="wpcf7-form-control wpcf7-text wpcf7-country wpcf7-validates-as-required wpcf7-validates-as-country" aria-required="true" aria-invalid="false" >
