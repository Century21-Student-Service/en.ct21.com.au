...
class HTML
{
     ...
     * @param type $no_cache
     */
    public static function forwardBackToReferer($no_cache = false)
    {
     ...
     * @param type $no_cache
     */
    public static function forward($destination, $http_response_code = false, $no_cache = false)
    {
        $settings = Vars::getSettings();
    ...
    public static function redirectToI18nUrl()
    {
        $uri = get_request_uri();
     ...
     * @param type $content
     */
    public static function sendJSONresponse($content)
    {
     ...
     */
    public static function registerFooterUpper($content)
    {
        self::$footer_upper .= $content;
    }
    public static function renderFooterUpperRegistry()
    {
        return self::$footer_upper;
    }
    public static function renderOutFooterUpperRegistry()
    {
        echo self::renderFooterUpperRegistry();
    }

    public static function registerFooterLower($content)
    {
        self::$footer_lower .= $content;
    }
    public static function renderFooterLowerRegistry()
    {
        return self::$footer_lower;
    }
    public static function renderOutFooterLowerRegistry()
    {
        echo self::renderFooterLowerRegistry();
    }

    public static function registerHeaderUpper($content)
    {
        self::$header_upper .= $content;
    }
    public static function renderHeaderUpperRegistry()
    {
        return self::$header_upper;
    }
    public static function renderOutHeaderUpperRegistry()
    {
        echo self::renderHeaderUpperRegistry();
    }

    public static function registerHeaderLower($content)
    {
        self::$header_lower .= $content;
    }
    public static function renderHeaderLowerRegistry()
    {
        return self::$header_lower;
    }
    public static function renderOutHeaderLowerRegistry()
    {
        echo self::renderHeaderLowerRegistry();
    }

    public static function registerSettingsInJs(array $keys)
    {
        self::$settings_in_js = array_merge($keys, is_array(self::$settings_in_js) ? self::$settings_in_js : array());
    }
    public static function renderSettingsInJson()
    {
