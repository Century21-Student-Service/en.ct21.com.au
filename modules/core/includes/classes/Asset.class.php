...
class Asset
{
    ...
    public static function getTopAssets($type, $which_end)
    {
        $rtn = array();
        $keys = array();
    ...
    public static function getBottomAssets($type, $which_end)
    {
        $rtn = array();
        $keys = array();
        foreach (self::getAllAssets($which_end) as $asset) {
    ...
    public static function getAllAssets($which_end)
    {
    ...
    public static function printTopAssets($which_end)
    {
    ...
    public static function printBottomAssets($which_end)
    {
    ...
    public static function checkAssetAdded($key, $type, $whichend)
    {
    ...
    public static function checkAssetAddedDynamicly($key, $type, $whichend)
    {
    ...
    public static function addDynamicAsset($key, $type, $whichend, $content)
    {
        global $dynamic_assets;
        if (!isset($dynamic_assets)) {
            $dynamic_assets = array();
    ...
    public static function getDynamicAsset($key, $type, $whichend)
    {
        global $dynamic_assets;
        return $dynamic_assets[$whichend][$type][$key];
    }

    public static function getAllDynamicAssets($type, $whichend)
    {
        global $dynamic_assets;
        return isset($dynamic_assets[$whichend][$type]) && is_array($dynamic_assets[$whichend][$type]) ? $dynamic_assets[$whichend][$type] : array();
    }

    public static function renderAllDynamicAssets($type, $whichend)
    {
    ...
    public static function clearDynamicAssets()
    {
        global $dynamic_assets;
        $dynamic_assets = null;
